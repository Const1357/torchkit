...
class SKTorchClassifier(SKTorchEstimatorBase, ABC):
    ...
    def __init__(
        self,
        *,
        classes: np.ndarray | None = None,  # optional; if not provided, trainer may infer and set classes_
        backbone_factory: ModuleFactory,
        head_factory: ModuleFactory,
        ...
        # fitted attrs (sklearn-like)
        # If `classes` was provided, we can expose it immediately as `classes_`.
